...
func (_m *Querier) GetBackingsForUser(ctx context.Context, userID uuid.UUID) ([]db.Backing, error) {
...
func (_c *Querier_GetBackingsForUser_Call) Run(run func(ctx context.Context, userID uuid.UUID)) *Querier_GetBackingsForUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID))
	})
	return _c
...
func (_m *Querier) GetCerificateByID(ctx context.Context, id uuid.UUID) (db.Certificate, error) {
	ret := _m.Called(ctx, id)
	...
	var r0 db.Certificate
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (db.Certificate, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) db.Certificate); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Get(0).(db.Certificate)
	}
...
func (_c *Querier_GetCerificateByID_Call) Run(run func(ctx context.Context, id uuid.UUID)) *Querier_GetCerificateByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID))
	})
	return _c
...
func (_c *Querier_GetCerificateByID_Call) RunAndReturn(run func(context.Context, uuid.UUID) (db.Certificate, error)) *Querier_GetCerificateByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetCurrentMilestone provides a mock function with given fields: ctx, projectID
func (_m *Querier) GetCurrentMilestone(ctx context.Context, projectID uuid.UUID) (db.Milestone, error) {
	ret := _m.Called(ctx, projectID)
...
func (_c *Querier_GetCurrentMilestone_Call) Run(run func(ctx context.Context, projectID uuid.UUID)) *Querier_GetCurrentMilestone_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID))
	})
	return _c
...
func (_c *Querier_GetCurrentMilestone_Call) RunAndReturn(run func(context.Context, uuid.UUID) (db.Milestone, error)) *Querier_GetCurrentMilestone_Call {
	_c.Call.Return(run)
	return _c
}
