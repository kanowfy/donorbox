...
func (_m *Backing) AcceptBacking(ctx context.Context, projectID int64, req dto.BackingRequest) error {
...
func (_c *Backing_AcceptBacking_Call) Run(run func(ctx context.Context, projectID int64, req dto.BackingRequest)) *Backing_AcceptBacking_Call {
...
func (_c *Backing_AcceptBacking_Call) RunAndReturn(run func(context.Context, int64, dto.BackingRequest) error) *Backing_AcceptBacking_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Backing) GetProjectBackingAggregation(ctx context.Context, projectID int64) (*service.BackingAggregation, error) {
	ret := _m.Called(ctx, projectID)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) (*service.BackingAggregation, error)); ok {
		return rf(ctx, projectID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) *service.BackingAggregation); ok {
		r0 = rf(ctx, projectID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Backing_GetProjectBackingAggregation_Call) Run(run func(ctx context.Context, projectID int64)) *Backing_GetProjectBackingAggregation_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
func (_c *Backing_GetProjectBackingAggregation_Call) RunAndReturn(run func(context.Context, int64) (*service.BackingAggregation, error)) *Backing_GetProjectBackingAggregation_Call {
	_c.Call.Return(run)
	return _c
}
