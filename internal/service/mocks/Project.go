...
// CheckAndUpdateFinishedProjects provides a mock function with given fields: ctx
func (_m *Project) CheckAndUpdateFinishedProjects(ctx context.Context) error {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for CheckAndUpdateFinishedProjects")
	}
...
// Project_CheckAndUpdateFinishedProjects_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckAndUpdateFinishedProjects'
type Project_CheckAndUpdateFinishedProjects_Call struct {
	*mock.Call
}

// CheckAndUpdateFinishedProjects is a helper method to define mock.On call
//   - ctx context.Context
func (_e *Project_Expecter) CheckAndUpdateFinishedProjects(ctx interface{}) *Project_CheckAndUpdateFinishedProjects_Call {
	return &Project_CheckAndUpdateFinishedProjects_Call{Call: _e.mock.On("CheckAndUpdateFinishedProjects", ctx)}
}

func (_c *Project_CheckAndUpdateFinishedProjects_Call) Run(run func(ctx context.Context)) *Project_CheckAndUpdateFinishedProjects_Call {
...
func (_c *Project_CheckAndUpdateFinishedProjects_Call) Return(_a0 error) *Project_CheckAndUpdateFinishedProjects_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Project_CheckAndUpdateFinishedProjects_Call) RunAndReturn(run func(context.Context) error) *Project_CheckAndUpdateFinishedProjects_Call {
	_c.Call.Return(run)
	return _c
}
